...
import { getLatestReviews } from "@/lib/api/prompts";
          ...
          {reviews.map((review, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-zinc-800/60">
                <div className="w-10 h-10 rounded-full bg-purple-950/40 border border-purple-900/50 flex items-center justify-center text-purple-400 font-bold text-sm shrink-0">
